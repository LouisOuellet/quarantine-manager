<main>
  <div class="sidebar d-flex flex-column flex-shrink-0 bg-light">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li>
        <a href="#dashboard" class="nav-link active py-3 border-bottom" title="<?= $this->Fields['Dashboard'] ?>" data-bs-toggle="tooltip" data-bs-placement="right">
    ...
    <div class="dropdown border-top" title="<?= $this->Fields['Profile'] ?>" data-bs-toggle="tooltip" data-bs-placement="right">
      <a href="#" class="d-flex align-items-center justify-content-center p-3 link-dark text-decoration-none dropdown-toggle" id="UserMenu" data-bs-toggle="dropdown" aria-expanded="false">
