    ...
    <form id="SetupWizard" name="SetupWizard" method="post">
      <div id="accordion">
        <div class="collapse show" data-bs-parent="#accordion" id="welcome">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#imap" data-bs-toggle="collapse" aria-expanded="false" class="btn btn-primary float-right"><?= $this->Fields['Get Started'] ?><i class="nav-icon fas fa-chevron-right ml-2"></i></button>
            </div>
          </div>
        </div>
        <div class="collapse" data-bs-parent="#accordion" id="imap">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0"><?= $this->Fields['IMAP'] ?></h5>
            </div>
            <div class="card-body">
              <p class="card-text">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10 input-group">
                    ...
                    <select class="form-control select2bs4" name="imap_encryption" id="imap_encryption">
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#welcome" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
              <button type="button" data-bs-target="#smtp" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-primary float-right"><?= $this->Fields['Next'] ?><i class="nav-icon fas fa-chevron-right ml-2"></i></button>
            </div>
          </div>
        </div>
        <div class="collapse" data-bs-parent="#accordion" id="smtp">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h5 class="m-0"><?= $this->Fields['SMTP'] ?></h5>
            </div>
            <div class="card-body">
              <p class="card-text">
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10 input-group">
                    ...
                    <select class="form-control select2bs4" name="smtp_encryption" id="smtp_encryption">
                      <option value="ssl"><?= $this->Fields['SSL'] ?></option>
                      <option value="starttls"><?= $this->Fields['STARTTLS'] ?></option>
                      <option value="none"><?= $this->Fields['None'] ?></option>
                    </select>
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#imap" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
              <button type="button" data-bs-target="#site" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-primary float-right"><?= $this->Fields['Next'] ?><i class="nav-icon fas fa-chevron-right ml-2"></i></button>
            </div>
          </div>
        </div>
        <div class="collapse" data-bs-parent="#accordion" id="site">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#imap" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
              <button type="button" data-bs-target="#license" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-primary float-right"><?= $this->Fields['Next'] ?><i class="nav-icon fas fa-chevron-right ml-2"></i></button>
            </div>
          </div>
        </div>
        <div class="collapse" data-bs-parent="#accordion" id="license">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#site" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
              <button type="button" id="reviewBTN" data-bs-target="#review" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-primary float-right"><?= $this->Fields['Next'] ?><i class="nav-icon fas fa-chevron-right ml-2"></i></button>
            </div>
          </div>
        </div>
        <div class="collapse" data-bs-parent="#accordion" id="review">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="button" data-bs-target="#license" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
        ...
        <div class="collapse" data-bs-parent="#accordion" id="log">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <button type="button" data-action="back" data-bs-target="#welcome" data-bs-toggle="collapse" aria-expanded="false"  class="btn btn-default"><i class="nav-icon fas fa-chevron-left mr-2"></i><?= $this->Fields['Back'] ?></button>
